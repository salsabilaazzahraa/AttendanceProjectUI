...
void _loadSchedules() async {
    ...
    List<String>? schedulesJson = prefs.getStringList('schedules');
    if (schedulesJson != null) {
      setState(() {
        schedules = schedulesJson.map((scheduleJson) => Schedule.fromJson(jsonDecode(scheduleJson))).toList();
      });
    }
  }
  ...
  void _saveSchedules() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> schedulesJson = schedules.map((schedule) => jsonEncode(schedule.toJson())).toList();
