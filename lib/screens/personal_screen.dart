...
class _PersonalScreenState extends State<PersonalScreen> {
  ...
  Future<void> _savePersonalInfo(PersonalInfo updatedInfo) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('name', updatedInfo.name);
    await prefs.setString('phoneNumber', updatedInfo.phoneNumber);
    await prefs.setString('email', updatedInfo.email);
    await prefs.setString('dob', updatedInfo.dob);
    await prefs.setString('gender', updatedInfo.gender);
    await prefs.setString('address', updatedInfo.address);
    await prefs.setString('emergencyPhone', updatedInfo.emergencyPhone);
    await prefs.setString('employeeID', updatedInfo.employeeID);
    await prefs.setString('department', updatedInfo.department);
    await prefs.setString('position', updatedInfo.position);
